...
<div class="fixed inset-0 overflow-hidden pointer-events-none">
    <img src="{{ asset('img/tycake.png') }}" class="floating-object" style="left: 10%; animation-delay: 0s; width: 40px;">
    <img src="{{ asset('img/tycake.png') }}" class="floating-object" style="left: 30%; animation-delay: 2s; width: 60px;">
    <img src="{{ asset('img/tycake.png') }}" class="floating-object" style="left: 50%; animation-delay: 4s; width: 30px;">
    <img src="{{ asset('img/tycake.png') }}" class="floating-object" style="left: 70%; animation-delay: 1s; width: 50px;">
    <img src="{{ asset('img/tycake.png') }}" class="floating-object" style="left: 90%; animation-delay: 6s; width: 45px;">
</div>
<div class="bg-white p-8 rounded-lg shadow-md relative z-10"> 
    <h1 class= "text-3xl font-bold text-blue-600 text-center uppercase">Hello, {{ request('user') ?? 'Admin' }}!</h1>
...
<div class="bg-white p-6 rounded-lg shadow-md mt-6">
    ...
    <div class="flex flex-wrap justify-center gap-8">
        <div class="w-fit bg-grey border-2 border-blue-500 justify-center rounded-2xl p-2 shadow-lg">
            <img src="{{ asset('img/basah.jpeg') }}" alt="Produk Basah" class="w-32 h-32 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
        ...
        <div class="w-fit bg-grey border-2 border-blue-500 justify-center rounded-2xl p-2 shadow-lg">
            <img src="{{ asset('img/kering.jpeg') }}" alt="Produk Kering" class="w-32 h-32 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
        ...
        <div class="w-fit bg-grey border-2 border-blue-500 justify-center rounded-2xl p-2 shadow-lg">
            <img src="{{ asset('img/donuts.png') }}" alt="Donut" class="w-32 h-32 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
        ...
        <div class="w-fit bg-grey border-2 border-blue-500 justify-center rounded-2xl p-2 shadow-lg">
            <img src="{{ asset('img/macaron.png') }}" alt="Macaron" class="w-32 h-32 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
        ...
        <div class="w-fit bg-grey border-2 border-blue-500 justify-center rounded-2xl p-2 shadow-lg">
            <img src="{{ asset('img/cookies.png') }}" alt="Cookies" class="w-32 h-32 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
        ...
        <div class="w-fit bg-grey border-2 border-blue-500 justify-center rounded-2xl p-2 shadow-lg">
            <img src="{{ asset('img/cheesecake.png') }}" alt="Cheesecake" class="w-32 h-32 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
        ...
        <div class="w-fit bg-grey border-2 border-blue-500 justify-center rounded-2xl p-2 shadow-lg">
            <img src="{{ asset('img/dubay-ceuwy.png') }}" alt="Dubai Chewy Cookie" class="w-32 h-32 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
    ...
    <div class="flex flex-wrap justify-center gap-8">
        <div class="w-64 border-2 border-blue-400 rounded-2xl p-4 shadow-lg flex flex-col justify-between items-center">
            <div class="flex-1 flex items-center justify-center w-full h-48">
                <img src="{{ asset('img/strawberry-milk-coffe.png') }}" alt="Strawberry Milk Coffee" class="w-40 h-40 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
            </div>
            <h3 class="font-bold text-center text-gray-800 mb-2">Strawberry Milk Coffee</h3>
        </div>
        <div class="w-64 border-2 border-blue-400 rounded-2xl p-4 shadow-lg flex flex-col justify-between items-center">
            <div class="flex-1 flex items-center justify-center w-full h-48">
                <img src="{{ asset('img/starwberry-coffe.png') }}" alt="Strawberry Coffee" class="w-40 h-40 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
            </div>
            <h3 class="font-bold text-center text-gray-800 mb-2">Strawberry Coffee</h3>
        </div>
        <div class="w-64 border-2 border-blue-400 rounded-2xl p-4 shadow-lg flex flex-col justify-between items-center">
            <div class="flex-1 flex items-center justify-center w-full h-48">
                <img src="{{ asset('img/matcha-strawberry.png') }}" alt="Matcha Strawberry" class="w-40 h-40 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
            </div>
            <h3 class="font-bold text-center text-gray-800 mb-2">Matcha Strawberry</h3>
        </div>
        <div class="w-64 border-2 border-blue-400 rounded-2xl p-4 shadow-lg flex flex-col justify-between items-center">
            <div class="flex-1 flex items-center justify-center w-full h-48">
                <img src="{{ asset('img/gula-aren.png') }}" alt="Gula Aren" class="w-40 h-40 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
            </div>
            <h3 class="font-bold text-center text-gray-800 mb-2">Gula Aren</h3>
        </div>
        <div class="w-64 border-2 border-blue-400 rounded-2xl p-4 shadow-lg flex flex-col justify-between items-center">
            <div class="flex-1 flex items-center justify-center w-full h-48">
                <img src="{{ asset('img/capucibo-lotus.png') }}" alt="Cappucino Lotus" class="w-40 h-40 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
            </div>
            <h3 class="font-bold text-center text-gray-800 mb-2">Cappucino Lotus</h3>
        </div>
        <div class="w-64 border-2 border-blue-400 rounded-2xl p-4 shadow-lg flex flex-col justify-between items-center">
            <div class="flex-1 flex items-center justify-center w-full h-48">
                <img src="{{ asset('img/butterschoct.png') }}" alt="Butterscotch" class="w-40 h-40 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
            </div>
            <h3 class="font-bold text-center text-gray-800 mb-2">Butterscotch</h3>
        </div>
        <div class="w-64 border-2 border-blue-400 rounded-2xl p-4 shadow-lg flex flex-col justify-between items-center">
            <div class="flex-1 flex items-center justify-center w-full h-48">
                <img src="{{ asset('img/matcha.png') }}" alt="Matcha" class="w-40 h-40 rounded-2xl  mt-6 object-cover shadow-lg object-center mx-auto">
            </div>
...
<div class="bg-white p-6 rounded-lg shadow-md mt-6">
    ...
    <div class="flex flex-wrap justify-center gap-8">
        <div class="w-64 border-2 border-blue-400 rounded-2xl p-4 shadow-lg flex flex-col justify-between items-center">
            <div class="flex-1 flex items-center justify-center w-full h-48">
                <img src="{{ asset('img/zip-lock.png') }}" alt="Zip Lock" class="w-full" style="max-width: 200px;" class="rounded-2xl  mt-6 object-cover object-center mx-auto">
            </div>
            <h3 class="font-bold text-center text-gray-800 mb-2">Zip Lock</h3>
        </div>
        <div class="w-64 border-2 border-blue-400 rounded-2xl p-4 shadow-lg flex flex-col justify-between items-center">
            <div class="flex-1 flex items-center justify-center w-full h-48">
                <img src="{{ asset('img/snack-pouch.png') }}" alt="Snack Pouch" class="w-full" style="max-width: 200px;" class="rounded-2xl  mt-6 object-cover object-center mx-auto">
            </div>
            <h3 class="font-bold text-center text-gray-800 mb-2">Snack Pouch</h3>
        </div>
        <div class="w-64 border-2 border-blue-400 rounded-2xl p-4 shadow-lg flex flex-col justify-between items-center">
            <div class="flex-1 flex items-center justify-center w-full h-48">
                <img src="{{ asset('img/box-(2).png') }}" alt="Box" class="w-full" style="max-width: 200px;" class="rounded-2xl  mt-6 object-cover object-center mx-auto">
            </div>
