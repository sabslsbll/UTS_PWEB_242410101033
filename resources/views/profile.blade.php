...
<div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl mt-10 p-8">
    <div class="md:flex-col flex items-center">
        ...
        <div class="p-8">
            <div class="flex items-center justify-center uppercase tracking-wide text-sm text-blue-500 font-bold">{{ strtoupper($role) }} Profile</div>
            <h1 class="flex items-center justify-center text-2xl leading-tight font-bold text-black uppercase">I'm {{ $username }}</h1>
            @if($role == 'user')
